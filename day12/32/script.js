...
var inpQuery = document.querySelector("#inpQuery");
var btnSubmit = document.querySelector("#btnSubmit");
var olOutput = document.querySelector("#olOutput");
btnSubmit === null || btnSubmit === void 0 ? void 0 : btnSubmit.addEventListener("click", handleSearching);
// document?.addEventListener("keyup", function (e) {
//   if (e.key == "Enter") handleSearching();
// });
function handleSearching(e) {
    return __awaiter(this, void 0, void 0, function () {
        var URL, state, req, data, _i, data_1, collegeName, li;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    e.preventDefault();
                    URL = "http://universities.hipolabs.com/search?country=india";
                    state = inpQuery.value.toLowerCase();
